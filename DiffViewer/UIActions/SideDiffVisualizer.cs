...
/// <summary>
/// Too Large meomery usage, Not Recommand
/// </summary>
public class SideBySideDiffModelVisualizer
{
    ...
    public static readonly DependencyProperty VorherProperty = DependencyProperty.RegisterAttached(
        "Vorher" ,
        typeof(SideBySideDiffModel) ,
    ...
    public static readonly DependencyProperty NachherProperty = DependencyProperty.RegisterAttached(
        "Nachher" , typeof(SideBySideDiffModel) ,
        typeof(SideBySideDiffModelVisualizer) ,
        new PropertyMetadata(null , new PropertyChangedCallback(NachherChanged)));

    private static async void NachherChanged(DependencyObject dep , DependencyPropertyChangedEventArgs e)
    {
        var richTextBox = (RichTextBox)dep;
        var diff = (SideBySideDiffModel)e.NewValue;
